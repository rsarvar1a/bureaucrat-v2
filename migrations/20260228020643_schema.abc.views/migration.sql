...
CREATE TABLE "abc"."Subscription" (
	...
	"action" text DEFAULT 'render' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "abc"."Subscription" ADD CONSTRAINT "Subscription_view_View_id_fkey" FOREIGN KEY ("view") REFERENCES "abc"."View"("id") ON DELETE CASCADE;--> statement-breakpoint
